# from https://github.com/yilundu/irem_code_release/blob/master/models.py

# Learning Iterative Reasoning through Energy Minimization


# Reasoning by Energy Minimization


# this is computed in every "Dynamic Model" prediction timestep, but goes here for the "hrm/trm"
# hierarchical reasoning models



# only computed in Inference, not in Training
