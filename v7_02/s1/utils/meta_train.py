...
from notebooks.v7_02.s1.cog_arch.encoder import Encoder
from notebooks.v7_02.s1.losses import BCS   # BCS kept as optional alternative



from data.dataloader import get_jepa_dataloaders
from notebooks.v7_02.s1.data.dataset import VOCAB_SIZE, tokenizer
...
def run(cfg=None):
    if cfg is None:
        from notebooks.v7_02.s1.config import CFG as cfg    # your existing config object
